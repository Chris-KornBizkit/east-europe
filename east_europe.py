...
with tab_local_picks:
    ...
    st.info("""
    **💡 여름 유럽 공통 추천 (6월):** 
    * **🍑 납작복숭아(Donut Peach):** 현지 마트(Spar, Billa, Tesco 등)나 로컬 시장에서 꼭 구매하세요! 일반 복숭아보다 당도가 훨씬 높은 제철 필수 과일입니다.
    * **🥂 내수용 화이트 와인:** 오스트리아와 체코의 화이트 와인은 퀄리티가 엄청난데도 대부분 자국 내에서 소비되어 한국에선 구하기 어렵습니다. 1일 1화이트 와인을 강력 추천합니다!
    """)
    ...
    with local_tabs[1]:
        ...
        * **그뤼너 벨트리너 (Grüner Veltliner):** 오스트리아의 대표 품종으로 만든 화이트 와인. 산뜻하고 청량해 더운 여름에 완벽합니다.
        """)
        st.markdown("#### 🎁 Must-Buy (특산물)")
        st.markdown("""
    ...
    with local_tabs[3]:
        ...
        * **모라비아 화이트 와인:** 맥주 강국 체코의 진정한 숨은 보석. 모라비아 지방에서 생산된 내수용 화이트 와인을 식당에서 꼭 곁들여보세요.
        """)
        st.markdown("#### 🎁 Must-Buy (특산물)")
        st.markdown("""
        * **납작복숭아:** 프라하 하벨 시장(Havel's Market) 등에서 가장 쉽게 구입할 수 있습니다.
