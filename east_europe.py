...
itinerary_data = [
    ...
    ["6/7 (일) - 부다페스트", "20:30", "관광", "구시가지 가벼운 산책", "[저녁] 파인다이닝 (1)", "구시가지 산책 및 첫 파인다이닝 디너"],
    
    ["6/8 (월) - 부다페스트", "07:00", "운동", "웨이트 트레이닝", "호텔 헬스장 또는 근처 피트니스", "아침 운동으로 상쾌하게 시작"],
    ["6/8 (월) - 부다페스트", "10:00", "관광", "부다 왕궁", "[명소 1] 부다 왕궁", "부다페스트의 상징적인 왕궁 탐방"],
    ["6/8 (월) - 부다페스트", "12:30", "중식", "점심 식사", "[점심] 고급 레스토랑 (2)", "고급 식당에서 런치"],
    ["6/8 (월) - 부다페스트", "14:00", "관광", "어부의 요새", "[명소 2] 어부의 요새", "도나우 강과 페스트 지구가 한눈에 보이는 명소"],
    ["6/8 (월) - 부다페스트", "15:00", "휴식", "숙소 휴식 (1시간)", "재정비 및 샤워", "오후 일정 전 체력 보충"],
    ["6/8 (월) - 부다페스트", "17:00", "관광", "겔레르트 언덕", "[명소 3] 겔레르트 언덕", "일몰 및 야경 감상 포인트"],
    ["6/8 (월) - 부다페스트", "19:30", "석식", "저녁 식사", "[저녁] 고급 레스토랑 (3)", "야경 감상 후 고급 다이닝"],
    
    ["6/9 (화) - 부다페스트", "07:00", "운동", "웨이트 트레이닝", "오운완", "-"],
    ["6/9 (화) - 부다페스트", "09:00", "관광", "세체니 온천", "[명소 1] 피로 회복", "유럽 최대 규모의 온천에서 힐링"],
    ["6/9 (화) - 부다페스트", "13:00", "중식", "점심 식사", "[점심] 고급 레스토랑 (4)", "온천 후 든든한 점심 식사"],
    ["6/9 (화) - 부다페스트", "15:00", "휴식", "숙소 휴식 (1시간)", "오후 재정비", "-"],
    ["6/9 (화) - 부다페스트", "16:30", "관광", "성 이슈트반 대성당", "[명소 2] 성 이슈트반 대성당", "건축미가 돋보이는 웅장한 대성당"],
    ...
    ["6/10 (수) - 빈", "12:30", "숙소", "빈 호텔 체크인", "짐 보관", "-"],
    ["6/10 (수) - 빈", "13:30", "중식", "점심 식사", "[점심] 파인다이닝 (5)", "음악의 도시 빈 입성 기념 파인다이닝"],
    ["6/10 (수) - 빈", "15:00", "관광", "슈테판 대성당", "[명소 1] 슈테판 대성당", "이동일로 오후 휴식 생략"],
    ["6/10 (수) - 빈", "16:30", "관광", "호프부르크 왕궁", "[명소 2] 호프부르크 왕궁", "합스부르크 왕가의 겨울 궁전 외관 및 주변 산책"],
    ...
    ["6/14 (일) - 잘츠부르크", "07:00", "운동", "웨이트 트레이닝", "오운완", "-"],
    ["6/14 (일) - 잘츠부르크", "10:00", "관광", "호엔잘츠부르크 성", "[명소 1] 푸니쿨라 탑승", "성곽에 올라 시내 조망"],
    ["6/14 (일) - 잘츠부르크", "13:00", "중식", "점심 식사", "[점심] 고급 레스토랑 (11)", "성벽 관람 후 고급 런치"],
    ["6/14 (일) - 잘츠부르크", "15:00", "휴식", "숙소 휴식 (1시간)", "재정비", "-"],
    ["6/14 (일) - 잘츠부르크", "16:30", "관광", "묀히스베르크 전망대", "[명소 2] 시내 전경 감상", "잘츠부르크 최고의 파노라마 뷰"],
    ["6/14 (일) - 잘츠부르크", "19:00", "석식", "저녁 식사", "[저녁] 파인다이닝 (12)", "로맨틱한 잘츠부르크 야경과 식사"],
    
    ["6/15 (월) - 할슈타트(근교)", "07:00", "운동", "웨이트 트레이닝", "오운완", "-"],
    ["6/15 (월) - 할슈타트(근교)", "09:00", "이동", "할슈타트 당일치기", "숙소 휴식 제외", "동화 같은 호수 마을 투어 출발"],
    ["6/15 (월) - 할슈타트(근교)", "11:30", "관광", "할슈타트 호수 마을", "[명소 1] 할슈타트 호수 마을", "자연 경관이 어우러진 산책"],
    ["6/15 (월) - 할슈타트(근교)", "13:00", "중식", "점심 식사", "일반 로컬 식당", "아름다운 호수를 보며 점심"],
    ["6/15 (월) - 할슈타트(근교)", "14:30", "관광", "파이브 핑거스 전망대", "[명소 2] 알프스 만년설 조망", "알프스 뷰 감상"],
    ["6/15 (월) - 할슈타트(근교)", "18:30", "이동", "잘츠부르크 복귀", "이동", "-"],
    ["6/15 (월) - 할슈타트(근교)", "19:30", "석식", "저녁 식사", "[저녁] 고급 레스토랑 (13)", "수고한 하루를 보상하는 고급 만찬"],
    ...
    ["6/16 (화) - 프라하", "16:00", "관광", "카를교", "[명소 1] 도보 횡단", "프라하 낭만의 중심지 산책"],
    ["6/16 (화) - 프라하", "18:00", "석식", "저녁 식사", "[저녁] 고급 레스토랑 (14)", "카를교 인근 다이닝"],
    ...
    ["6/17 (수) - 프라하", "15:00", "휴식", "숙소 휴식 (1시간)", "재정비", "-"],
    ...
    ["6/19 (금) - 프라하", "10:00", "관광", "하벨 시장", "[명소 1] 가벼운 산책", "현지 시장"],
    ["6/19 (금) - 프라하", "12:30", "중식", "점심 식사", "일반 로컬 식당", "로컬 맛집 탐방"],
    ["6/19 (금) - 프라하", "15:00", "휴식", "숙소 휴식 (1시간)", "재정비", "-"],
    ["6/19 (금) - 프라하", "16:30", "관광", "블타바 강 페달 보트", "[명소 2] 액티비티", "강 위에서 여유로운 오후 즐기기"],
    ["6/19 (금) - 프라하", "19:00", "석식", "저녁 식사", "[저녁] 미슐랭/파인다이닝 (18)", "프라하 여행의 하이라이트 디너"],
...
with tab0:
    ...
    df_themes = pd.DataFrame([
        ["부다페스트", "6/7 - 6/9", "다뉴브 강의 진주", "야경 크루즈, 미슐랭 다이닝, 뉴욕 카페"],
        ["오스트리아 빈", "6/9 - 6/12", "클래식과 럭셔리", "콜마르크트 명품 쇼핑, 호프부르크, 콘서트"],
        ["잘츠부르크", "6/12 - 6/15", "음악과 자연", "모차르트 디너, 미라벨 궁전, 할슈타트(옵션)"],
        ["프라하", "6/15 - 6/20", "보헤미안 낭만", "파르지주스카 쇼핑, 카를교, 프라하 성"]
